...
export default class Anime {
        ...
        constructor(){}
            async obtenerCatalogo(){
                const datos= await fetch("https://api.jikan.moe/v3/search/anime?q=High%20school%20dxd")
            /* especificamos que los datos lleguen en formato JSON */
                ...
                datos_definitivos.forEach(element => {
                    ...
                    <div class="row g-0">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text"><small class="text-muted">"cantidad episodios: "${element.episodes}</small></p>
                        </div>
                        </div>
                    </div>
                    </div>
